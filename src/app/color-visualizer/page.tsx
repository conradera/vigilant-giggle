    ...
    <div className="-mt-20">
      ...
      <section className="relative h-[60vh] w-full overflow-hidden bg-deep-forest">
        <div className="absolute inset-0 z-0">
          <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,rgba(30,120,60,0.3),transparent)]"></div>
          <div className="absolute inset-0 bg-gradient-to-t from-black/70 via-deep-forest/50 to-deep-forest/80"></div>
        </div>
