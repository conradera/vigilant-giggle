        ...
        <div className="flex flex-col lg:flex-row lg:justify-between gap-12 pb-10">
          ...
          <div className="max-w-xs">
            ...
            <div className="flex gap-3">
              ...
              <a href="https://tiktok.com/@NimpaintsUganda" target="_blank" rel="noopener noreferrer" aria-label="TikTok" className="w-10 h-10 rounded-full border border-deep-forest/20 flex items-center justify-center text-deep-forest hover:bg-deep-forest hover:text-white transition-all">
